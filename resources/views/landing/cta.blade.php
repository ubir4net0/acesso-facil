            ...
            <div class="grid lg:grid-cols-2 gap-12 items-center">
                <div>
                    ...
                    <div class="space-y-4">
                        <div class="flex items-start space-x-3">
                            ...
                            <p class="text-gray-900"><strong>100% Gratuito</strong> - Sem taxas escondidas ou período de
                                teste</p>
                        </div>
                ...
                <div class="relative">
                    <div class="aspect-square gradient-secondary rounded-3xl shadow-glow relative overflow-hidden">
                        ...
                        <img src="{{ asset('images/locais.png') }}" alt="Captura de tela do app Acesso Fácil"
                            class="w-full h-full object-cover rounded-3xl">


                        <div class="absolute inset-0 bg-gradient-to-br from-transparent to-gray-900/30 rounded-3xl">
                        </div>
                        ...
                        <div class="absolute top-1/4 right-4">
                            <div
                                class="w-12 h-12 bg-white rounded-full shadow-lg flex items-center justify-center animate-pulse">
